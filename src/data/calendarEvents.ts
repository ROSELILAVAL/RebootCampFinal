...
export const calendarEvents = [
  // Original events
  {
    ...
    date: new Date(2024, 5, 3), // June 3, 2024 (Monday)
    endDate: new Date(2024, 5, 7), // June 7, 2024 (Friday)
    campId: "1",
  ...
  },
  {
    ...
    date: new Date(2024, 5, 10), // June 10, 2024 (Monday)
    endDate: new Date(2024, 5, 14), // June 14, 2024 (Friday)
    campId: "2",
  ...
  },
  {
    id: "event-3",
    title: "Robotique & IA",
    date: new Date(2024, 5, 17), // June 17, 2024 (Monday)
    endDate: new Date(2024, 5, 21), // June 21, 2024 (Friday)
    campId: "3",
  ...
  },
  {
    ...
    date: new Date(2024, 5, 24), // June 24, 2024 (Monday)
    endDate: new Date(2024, 5, 28), // June 28, 2024 (Friday)
    campId: "4",
  ...
  },
  {
    ...
    date: new Date(2024, 6, 1), // July 1, 2024 (Monday)
    endDate: new Date(2024, 6, 5), // July 5, 2024 (Friday)
    campId: "5",
  ...
  },
  {
    ...
    date: new Date(2024, 6, 8), // July 8, 2024 (Monday)
    endDate: new Date(2024, 6, 12), // July 12, 2024 (Friday)
    campId: "6",
  ...
  },
  {
    id: "event-7",
    title: "Minecraft & Programmation",
    date: new Date(2024, 6, 15), // July 15, 2024 (Monday)
    endDate: new Date(2024, 6, 19), // July 19, 2024 (Friday)
    campId: "1",
    image: "https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    description: "Apprends à programmer en créant des mondes et des jeux dans Minecraft.",
    morningAvailable: true,
  ...
  },
  {
    id: "event-8",
    title: "Création de Jeux Vidéo",
    date: new Date(2024, 6, 22), // July 22, 2024 (Monday)
    endDate: new Date(2024, 6, 26), // July 26, 2024 (Friday)
    campId: "2",
    image: "https://images.unsplash.com/photo-1511512578047-dfb367046420?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    description: "Crée ton propre jeu vidéo et apprends les bases de la programmation ludique.",
    morningAvailable: true,
  ...
  },
  {
    id: "event-9",
    title: "Développement Web",
    date: new Date(2024, 7, 5), // August 5, 2024 (Monday)
    endDate: new Date(2024, 7, 9), // August 9, 2024 (Friday)
    campId: "4",
    image: "https://images.unsplash.com/photo-1593720213428-28a5b9e94613?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    description: "Initie-toi au développement web et crée ton premier site internet.",
    morningAvailable: true,
  ...
  },
  {
    id: "event-10",
    title: "Robotique & IA",
    date: new Date(2024, 7, 12), // August 12, 2024 (Monday)
    endDate: new Date(2024, 7, 16), // August 16, 2024 (Friday)
    campId: "3",
    image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    description: "Découvre la robotique et l'intelligence artificielle à travers des projets amusants.",
    morningAvailable: false,
  ...
  },
  {
    id: "event-11",
    title: "Python pour débutants",
    date: new Date(2024, 7, 19), // August 19, 2024 (Monday)
    endDate: new Date(2024, 7, 23), // August 23, 2024 (Friday)
    campId: "5",
    image: "https://images.unsplash.com/photo-1526379879527-8559ecfcb0c8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    description: "Apprends les bases de Python, le langage de programmation utilisé par les professionnels.",
    morningAvailable: true,
  ...
  },
  {
    id: "event-12",
    title: "Électronique & Arduino",
    date: new Date(2024, 7, 26), // August 26, 2024 (Monday)
    endDate: new Date(2024, 7, 30), // August 30, 2024 (Friday)
    campId: "6",
    image: "https://images.unsplash.com/photo-1553406830-ef409b4a6598?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    description: "Explore l'électronique et la programmation avec Arduino dans ce stage pratique.",
    morningAvailable: true,
  ...
  // New additional events
  {
    ...
    date: new Date(2024, 3, 8), // April 8, 2024 (Monday)
    endDate: new Date(2024, 3, 12), // April 12, 2024 (Friday)
    campId: "7",
  ...
  },
  {
    ...
    date: new Date(2024, 3, 15), // April 15, 2024 (Monday)
    endDate: new Date(2024, 3, 19), // April 19, 2024 (Friday)
    campId: "8",
  ...
  },
  {
    ...
    date: new Date(2024, 3, 22), // April 22, 2024 (Monday)
    endDate: new Date(2024, 3, 26), // April 26, 2024 (Friday)
    campId: "9",
  ...
  },
  {
    ...
    date: new Date(2024, 4, 6), // May 6, 2024 (Monday)
    endDate: new Date(2024, 4, 10), // May 10, 2024 (Friday)
    campId: "10",
  ...
  },
  {
    ...
    date: new Date(2024, 4, 13), // May 13, 2024 (Monday)
    endDate: new Date(2024, 4, 17), // May 17, 2024 (Friday)
    campId: "11",
  ...
  },
  {
    ...
    date: new Date(2024, 4, 27), // May 27, 2024 (Monday) 
    endDate: new Date(2024, 4, 31), // May 31, 2024 (Friday)
    campId: "12",
  ...
  },
  {
    ...
    date: new Date(2024, 8, 2), // September 2, 2024 (Monday)
    endDate: new Date(2024, 8, 6), // September 6, 2024 (Friday)
    campId: "13",
  ...
  },
  {
    ...
    date: new Date(2024, 8, 16), // September 16, 2024 (Monday)
    endDate: new Date(2024, 8, 20), // September 20, 2024 (Friday)
    campId: "14",
