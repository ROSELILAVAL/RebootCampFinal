    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className={cn(
            ...
            <h2 className="text-3xl font-bold text-center mb-8">{t.aboutOurMission}</h2>
            <p className="text-xl text-gray-600 text-center mb-8">
              {t.aboutOurMissionDescription}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="bg-blue-50 p-8 rounded-lg text-center">
                ...
                <h3 className="text-xl font-semibold mb-3">{t.aboutEducation}</h3>
                <p className="text-gray-600">
                  {t.aboutEducationDescription}
                </p>
              </div>
              ...
              <div className="bg-purple-50 p-8 rounded-lg text-center">
                ...
                <h3 className="text-xl font-semibold mb-3">{t.aboutPassion}</h3>
                <p className="text-gray-600">
                  {t.aboutPassionDescription}
                </p>
              </div>
              ...
              <div className="bg-green-50 p-8 rounded-lg text-center">
                ...
                <h3 className="text-xl font-semibold mb-3">{t.aboutCommunity}</h3>
                <p className="text-gray-600">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className={cn(
            ...
            <h2 className="text-3xl font-bold text-center mb-8">{t.aboutOurStory}</h2>
            
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <p className="text-gray-600 mb-4">
                {t.aboutOurStoryParagraph1}
              </p>
              <p className="text-gray-600 mb-4">
                {t.aboutOurStoryParagraph2}
              </p>
              <p className="text-gray-600">
                {t.aboutOurStoryParagraph3}
              </p>
              
              <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
                  <p className="text-3xl font-bold text-blue-600">{t.aboutStudentsCount}</p>
                  <p className="text-sm text-gray-500">{t.aboutStudentsLabel}</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-blue-600">{t.aboutCampsCount}</p>
                  <p className="text-sm text-gray-500">{t.aboutCampsLabel}</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-blue-600">{t.aboutInstructorsCount}</p>
                  <p className="text-sm text-gray-500">{t.aboutInstructorsLabel}</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-blue-600">{t.aboutCitiesCount}</p>
                  <p className="text-sm text-gray-500">{t.aboutCitiesLabel}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          <div className={cn(
            ...
            <h2 className="text-3xl font-bold text-center mb-8">{t.aboutOurValues}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold">{t.aboutExcellenceTitle}</h3>
                </div>
                <p className="text-gray-600">
                  {t.aboutExcellenceDescription}
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold">{t.aboutInclusionTitle}</h3>
                </div>
                <p className="text-gray-600">
                  {t.aboutInclusionDescription}
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold">{t.aboutPracticalLearningTitle}</h3>
                </div>
                <p className="text-gray-600">
                  {t.aboutPracticalLearningDescription}
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold">{t.aboutCaringTitle}</h3>
                </div>
                <p className="text-gray-600">
                  {t.aboutCaringDescription}
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-500 to-purple-500 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">{t.aboutQuestionTitle}</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            {t.aboutQuestionSubtitle}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild variant="secondary">
              <Link to="/contact">
                {t.aboutContactUsButton}
              </Link>
            </Button>
          </div>
        </div>
